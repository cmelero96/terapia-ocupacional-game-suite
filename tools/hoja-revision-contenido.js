...
w(
  ...
  '---',
  '',
  '## 6 · Los dibujos del banco — MARCADORES',
  '',
  'Los 64 dibujos de los cuatro primeros grupos visuales **no son arte definitivo**: son',
  'dibujo de linea generado, para que el producto se pueda usar antes de encargar arte.',
  '',
  `Mira la galeria: ${cod('assets/art/banco/galeria.html')}. Sale en escala de grises y a`,
  '**24 px**, que es el tamano minimo que puedes configurar, porque es donde la confusion',
  'importa: a 140 px cualquier par de dibujos se distingue y eso no dice nada.',
  '',
  'Las tres preguntas, y ninguna la puede contestar una herramienta:',
  '',
  '1. **¿Se reconoce cada objeto a 24 px?** El trazo pasa el umbral de contraste (6,69:1 en el',
  '   peor caso) y es **fino**: el peor dibujo tiene 15 pixeles a media cobertura. Si a ti no',
  '   te parece legible, hay que engordar el trazo, y eso obliga a retirar los 64',
  '   identificadores y crear otros.',
  '2. **¿Los objetos de un mismo grupo se confunden entre si MAS que con los de otro grupo?**',
  '   Eso es lo que hace real la perilla de similitud visual. Esta medido y pasa, pero la',
  '   medida compara pixeles y tu comparas objetos.',
  '3. **¿Falta algun objeto de uso diario que usarias en consulta?**',
  '',
  '> Los grupos son: recipientes abiertos, redondeados, objetos de escritura y vehiculos con',
  '> ruedas. Faltan **doce** grupos mas para el banco completo de 256.',
  '',
  '---',
  '',
